...
- (void)layoutSubviews
{
    ...
    self.imageView.bounds = CGRectMake(0, 0, imageViewEdge, imageViewEdge*114/128);
...
+(instancetype)publishButton{
    ...
    [button setTitle:@"自助生成" forState:UIControlStateNormal];
...
- (void)clickPublish:(DWPublishButton *)sender {

//    [self postNotification:NOTIFICATION_MORE];
    
//    return;
//    UITabBarController *tabBarController = (UITabBarController *)self.window.rootViewController.tabBarController;
