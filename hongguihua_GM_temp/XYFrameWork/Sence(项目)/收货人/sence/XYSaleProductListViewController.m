//
//  XYSaleProductListViewController.m
//  XYFrameWork
//
...
@interface XYSaleProductListViewController ()

@end

@implementation XYSaleProductListViewController
...
- (void)initNet {
    [super initNet];
    XYWeakSelf
    [self xy_postWithValues:@{MTOKEN:m_token,MPAGENUMBER:m_pagenumber,MPAGESIZE:m_pagesize} ModelType:[XYSaleProductModel class] Path:i_sellgoodslist hud:nil Success:^(__kindof YTKBaseRequest *request, id model) {
